...
public class MqttHelper {
    ...
    final String clientId = "mqttdash-dc7c2875";
    final String subscriptionTopic = "MMoist001";
    final String subscriptionTopic2 = "SoilR";
    final String subscriptionTopic3 = "SoilG";
    final String subscriptionTopic4 = "SoilB";
    final String subscriptionTopic5 = "JJ7";
    ...
    private void subscribeToTopic() {
        try {
            mqttAndroidClient.subscribe(subscriptionTopic, 0, null, new IMqttActionListener() {
                @Override
                public void onSuccess(IMqttToken asyncActionToken) {
                    Log.w("Moist001","Subscribed!");
                }

                @Override
                public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                    Log.w("Moist001", "Subscribed fail!");
                }
            });
            ...
            mqttAndroidClient.subscribe(subscriptionTopic5, 0, null, new IMqttActionListener() {
                @Override
                public void onSuccess(IMqttToken asyncActionToken) {
                    Log.w("Moist001","Subscribed!");
                }
